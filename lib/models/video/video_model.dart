...
class VideoRequest {
  ...
  static Future<DeleteVideoModel> deleteVideo({
    required int? videoId,
    required int? userId,
    required String? token,
  }) async {
    String url = ApiConfig.baseUrl + "/video/deleteUserVideo";
    var response = await BaseRequest().toPost(
      url,
      parameters: {
        "videoId": videoId,
    ...
    DeleteVideoModel scModel = DeleteVideoModel.fromJson(response);
...
class DeleteVideoModel {
  ...
  DeleteVideoModel.fromJson(dynamic json) {
    _code = json['code'];
    _msg = json['msg'];
    _data = json['data'];
  }
